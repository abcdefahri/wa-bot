...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/abcdefahri/wa-bot)
...
```bash
git clone https://github.com/abcdefahri/wa-bot
cd wa-bot
npm install
npm update
```
